...
<div class="header bg-main">
  ...
  <div class="head-l" ><a href="" target="_blank" style="color:#FFF" ><span class="icon-user"></span> 欢迎<%=userid %></a>&nbsp;&nbsp;<a class="button button-little bg-green" href="" target="_blank" ><span class="icon-home"></span> 首页</a> &nbsp;&nbsp;<a class="button button-little bg-red" href="auth/action_logout.jsp"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="page/instructor/instructor_edit.jsp?userid=<%=userid%>" target="right"><span class="icon-caret-right"></span>个人设置</a></li> 
