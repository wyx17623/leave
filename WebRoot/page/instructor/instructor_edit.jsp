...
<% 
   ...
   request.setCharacterEncoding("utf-8");
    String instID=request.getParameter("userid");
    if(instID ==null){
...
<body>
 <div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="page/instructor/action_editinstructor.jsp">  
      <div class="form-group">
        <div class="label">
          <label>辅导员工号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50"  readonly="readonly" value="<%=rs_instID %>"name="instID" data-validate="required:" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=rs_instName %>" name="instName" data-validate="required:请输入辅导员姓名" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
       ...
       while(rs1.next()){
        ...
        %>       
            <option value="<%=depID%>"><%=depID %><%=depName %></option>
      <%} %>
      </select></div>
       <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=rs_telephone %>" name="telephone" data-validate="required:请输入联系方式" />
          <div class="tips"></div>
        </div>
      </div>
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="<%=rs_email%>" name="email" data-validate="required:请输入email" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
